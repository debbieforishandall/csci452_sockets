...
int main(int argc, char *argv[]) {
    ...
    //char     		*h_addr;                /*  for hostent IP address    */		
    ...
    //h_addr = server->h_addr_list[0]  //use first IP returned by hostent
    ...
    if ( inet_aton(server->h_addr, &servaddr.sin_addr) <= 0 ) { //fix char pointer
